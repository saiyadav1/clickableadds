...
export default function TestimonialSection() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center bg-[#0B0F19] overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-slate-600/10 rounded-full blur-[100px] -translate-y-1/2 pointer-events-none" />
      ...
      <div className="relative z-10 w-[90%] max-w-5xl mx-auto px-6 py-20 flex flex-col gap-12 md:gap-16">
        ...
        <div className="relative max-w-4xl mx-auto w-full">
                ...
                <div className="flex justify-center py-2">
                  <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-[3rem] px-8 py-10 md:px-16 md:py-14 flex flex-col md:flex-row items-center gap-10 md:gap-14 shadow-2xl">
                    ...
                    <div className="relative w-36 h-36 md:w-48 md:h-48 shrink-0">
                      <div className="absolute inset-0 bg-slate-600 rounded-full blur-2xl opacity-20" />
                      ...
                      <div className="absolute -bottom-1 -right-1 bg-slate-600 h-10 w-10 rounded-full flex items-center justify-center shadow-lg border-2 border-[#0B0F19]">
          ...
          <div className="absolute -bottom-14 md:bottom-1/2 md:-translate-y-1/2 left-0 right-0 md:-left-20 md:-right-20 flex md:flex-col justify-center gap-6 md:gap-4">
            <button className="prev-testimonial w-12 h-12 rounded-full bg-white/5 border border-white/10 text-white flex items-center justify-center hover:bg-slate-600 transition-all duration-300 backdrop-blur-md">
              <span className="text-sm">←</span>
            </button>
            <button className="next-testimonial w-12 h-12 rounded-full bg-white/5 border border-white/10 text-white flex items-center justify-center hover:bg-slate-600 transition-all duration-300 backdrop-blur-md">
              <span className="text-sm">→</span>
            </button>
          </div>
        </div>
