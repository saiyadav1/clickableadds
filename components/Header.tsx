        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex items-center justify-between">
                        ...
                        <div className="invisible absolute left-0 top-full pt-4 opacity-0 transition-all duration-300 group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 translate-y-2">
                          <ul className="w-80 rounded-3xl border border-gray-100 bg-white p-3 shadow-[0_20px_50px_rgba(0,0,0,0.1)] overflow-hidden">
                            <div className="px-4 py-2 mb-2 border-b border-slate-50">
                                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Our Expertise</span>
                            </div>
            ...
            <div className="flex items-center gap-3 relative z-[110]">
              <Link 
                href="/contact" 
                className="hidden md:flex items-center gap-2 rounded-full bg-[#05003b] px-7 py-3 text-[13px] font-black uppercase tracking-widest text-white hover:bg-blue-600 transition-all shadow-xl shadow-blue-900/10 active:scale-95"
              >
                Get a Quote
              </Link>
              ...
              <button
                ...
                className="xl:hidden flex items-center justify-center h-12 w-12 rounded-2xl bg-white text-slate-900 shadow-md border border-slate-100 active:scale-90 transition-all"
              >
                        ...
                        <div className="flex flex-col">
                          <button
                            ...
                            className={`flex w-full items-center justify-between px-6 py-5 text-base font-bold transition-colors ${
                              activeDropdown === item.label ? "text-blue-600 bg-blue-50/50" : "text-slate-800"
                            }`}
                          >
                            {item.label}
                            {activeDropdown === item.label ? <Minus className="h-5 w-5" /> : <Plus className="h-5 w-5" />}
                          </button>
                          <AnimatePresence>
