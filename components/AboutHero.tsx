          ...
          <div className="w-full lg:w-1/2">
            <div className="relative group">
              ...
              <motion.div 
                ...
                className="absolute inset-0 bg-slate-600/5 -m-10 z-0"
              />
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative">
              ...
              >
                ...
                <h1 className="text-5xl md:text-6xl font-black text-[#05003b] leading-[1] mb-10 tracking-tighter">
                  Working Hard <br />
                  To Make <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-600 to-indigo-500 italic">SEO Easy.</span>
                </h1>

                <div className="space-y-8">
                  <p className="text-xl md:text-2xl text-slate-700 font-semibold leading-relaxed border-l-4 border-slate-600 pl-6">
                ...
                <div className="flex flex-wrap items-center gap-8 mt-12">
                  <Link href="/contact" className="px-10 py-5 bg-[#05003b] text-white rounded-2xl font-bold uppercase tracking-[0.2em] text-[10px] transition-all hover:bg-slate-600 shadow-[0_20px_40px_rgba(5,0,59,0.2)] active:scale-95">
                    Start Your Journey
                  </Link>
