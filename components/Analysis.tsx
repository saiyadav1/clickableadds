    ...
    <section className="relative min-h-screen py-10 bg-white overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="relative w-[90%] max-w-6xl mx-auto z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          >
            <span className="text-slate-600 font-bold tracking-widest uppercase text-xs mb-2">
              Our Analysis
            </span>
        ...
        <div className="flex justify-center items-center gap-6 mb-20">
          <span className={`text-sm font-bold transition-colors duration-300 ${!isAfter ? "text-slate-600" : "text-slate-400"}`}>
            BEFORE 
          </span>
          <button
          ...
          >
            <motion.div
              ...
              className="w-6 h-6 bg-slate-600 rounded-full shadow-lg"
            />
          </button>
          <span className={`text-sm font-bold transition-colors duration-300 ${isAfter ? "text-slate-600" : "text-slate-400"}`}>
            AFTER 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
              <AnimatePresence mode="wait">
                {(isAfter ? DATA.after : DATA.before).map((stat, index) => (
                  ...
                  >
                    <h3 className="text-3xl md:text-4xl font-black text-slate-600 mb-2">
