      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-[60%] flex flex-col justify-center pr-6">
          <div className="flex items-center gap-4 mb-4">
            <span className="text-[10px] font-black uppercase tracking-widest text-primary bg-slate-50 px-3 py-1 rounded-lg">
              {blog.category || "Growth"}
            </span>
            <span className="text-slate-300 text-xs font-bold">{blog.publishDate}</span>
          </div>

          <h3 className="text-2xl font-bold text-[#05003b] leading-tight mb-4 group-hover:text-primary transition-colors">
