      ...
      <div className="relative mx-auto w-[90%] max-w-7xl">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-slate-900 leading-[1.1] mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-600 to-indigo-500">
              built for growth
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {servicesData.map((service) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4 leading-tight group-hover:text-slate-600 transition-colors">
                {service.title}
              </h3>
              ...
              <Link
                ...
                className={`group/btn inline-flex items-center gap-2 text-sm font-bold tracking-tight text-slate-600`}
              >
