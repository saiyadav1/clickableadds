        ...
        <div className="flex justify-center">
          <div className="w-full max-w-4xl text-center">
            ...
            >
              ...
              <div className="w-24 h-1 bg-blue-100 rounded-full relative">
                <motion.div 
                  initial={{ width: 0 }}
                  animate={{ width: '100%' }}
            ...
            >
              <form className="bg-white p-2 rounded-2xl md:rounded-full shadow-2xl border border-blue-50 flex flex-col md:flex-row items-center gap-2">
                <div className="relative w-full flex-1 group">
                  <Globe size={18} className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400" />
                  <input type="text" placeholder="https://yoursite.com" className="w-full pl-12 pr-4 py-4 rounded-full outline-none focus:bg-slate-50" />
                </div>
                <div className="hidden md:block w-px h-8 bg-slate-100" />
                <div className="relative w-full flex-1 group">
                  <Mail size={18} className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400" />
                  <input type="email" placeholder="youremail@domain.com" className="w-full pl-12 pr-4 py-4 rounded-full outline-none focus:bg-slate-50" />
                </div>
                <button className="w-full md:w-auto bg-blue-600 text-white px-8 py-4 rounded-xl md:rounded-full font-bold hover:bg-blue-700 shadow-lg active:scale-95 flex items-center justify-center gap-2">
