  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#f8faff] pt-32 pb-20 lg:pt-48 lg:pb-64">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="flex justify-center">
          <div className="w-full max-w-4xl text-center">
            ...
            >
              <span className="text-boxslate font-bold tracking-wide uppercase text-sm mb-2">
              ...
              <div className="w-24 h-1 bg-slate-100 rounded-full relative">
                <motion.div 
                  ...
                  className="absolute inset-0 bg-boxslate rounded-full" 
                />
              </div>
            </motion.div>
            <motion.h1 
            ...
            >
              Your Partner in <br className="hidden md:block" /> Digital Growth.
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
             Delivering industry-leading ROI with custom-built SEO strategies designed to dominate the search results.
            </motion.p>
            ...
            >
              ...
              className="bg-white p-2 rounded-2xl md:rounded-full shadow-2xl border border-slate-50 flex flex-col md:flex-row items-center gap-2">
                <div className="relative w-full flex-1 group">
                  <Globe size={18} className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400" />
                  <input type="text" name="website" placeholder="https://yoursite.com" className="w-full pl-12 pr-4 py-4 rounded-full outline-none focus:bg-slate-50" />
                </div>
                <div className="hidden md:block w-px h-8 bg-slate-100" />
                <div className="relative w-full flex-1 group">
                  <Mail size={18} className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400" />
                  <input type="email" name="email" placeholder="youremail@domain.com" className="w-full pl-12 pr-4 py-4 rounded-full outline-none focus:bg-slate-50" />
                </div>
                <button type="submit" className="w-full md:w-auto bg-slate-900 text-white px-8 py-4 rounded-xl md:rounded-full font-bold  shadow-lg active:scale-95 flex items-center justify-center gap-2">
      ...
      <div className="hidden lg:block absolute inset-0 pointer-events-none">
        ...
        >
          <Image src="/assets/img/shape/banner-plus.png" alt="plus" width={40} height={40} />
        </motion.div>
        ...
        >
          <Image src="/assets/img/shape/banner-dots.png" alt="dots" width={100} height={100} />
        </motion.div>
      </div>
