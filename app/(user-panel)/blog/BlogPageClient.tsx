        ...
        <div className="max-w-3xl mb-20">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-primary font-black uppercase tracking-[0.3em] text-[10px]">The Journal</span>
            </div>
            <h1 className="text-5xl md:text-7xl font-black text-[#05003b] tracking-tighter leading-[1.1]">
              Insights for the <br /> 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-indigo-600">Digital Elite.</span>
            </h1>
          </motion.div>
        </div>
