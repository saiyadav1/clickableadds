  ...
  return (
    <main className="bg-[#FAFAFB] min-h-screen overflow-hidden">
      ...
      <section className="relative pt-40 pb-24 bg-[#05003b] overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[700px] h-[700px] bg-primary/20 rounded-full blur-[150px] animate-pulse" />
        ...
        <div className="w-[90%] max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-slate-200/60 max-w-xl leading-relaxed mb-10 font-medium">
                {service.longDesc}
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                <Link 
                href={"/contact"}
                className="bg-primary hover:bg-slate-500 text-white px-10 py-5 rounded-2xl font-bold shadow-2xl shadow-primary/30 transition-all flex items-center gap-3 active:scale-95">
      ...
      <section className="py-32 relative">
        <div className="w-[90%] max-w-7xl mx-auto">
          <div className="mb-20">
            <h2 className="text-xs font-black uppercase tracking-[0.4em] text-primary mb-4">The Capabilities</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className={`md:col-span-4 ${service.bg} p-12 rounded-[3rem] flex flex-col items-center justify-center text-center space-y-4`}>
                <p className={`text-xs font-black uppercase tracking-widest text-primary`}>{service.stats.label}</p>
                <h5 className={`text-7xl font-black text-primary tracking-tighter`}>{service.stats.value}</h5>
      ...
      <section className="py-32 bg-white border-y border-slate-100">
        <div className="w-[90%] max-w-7xl mx-auto text-center mb-24">
          <h2 className="text-xs font-black uppercase tracking-[0.4em] text-primary mb-4">Our Methodology</h2>
   ...
   <section className="relative py-40 bg-white overflow-hidden">
        ...
        <div className="w-[90%] max-w-5xl mx-auto text-center relative z-10">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-100 text-primary text-[10px] font-black uppercase tracking-[0.3em] mb-8">
            ...
            <h2 className="text-5xl md:text-8xl font-black text-[#05003b] tracking-tighter leading-[0.95] mb-12">
              Ready to start a <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-indigo-600 italic">
                new journey?
              </span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Link 
                href="/contact" 
                className="group relative bg-[#05003b] text-white px-12 py-6 rounded-3xl font-black text-lg shadow-2xl shadow-slate-900/20 hover:bg-primary hover:-translate-y-2 transition-all duration-300 flex items-center gap-4"
              >
                Begin Your Journey
